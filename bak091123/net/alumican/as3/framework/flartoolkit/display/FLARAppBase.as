...
{	
	...
	public class FLARAppBase extends Sprite
	{
		 ...
		 */
		protected function init(paramURL:String, codeURL:String, cameraWidth:int = 320, cameraHeight:int = 240, codePhysicalWidth:int = 80, codeDivisionX:int = 16, codeDivisionY:int = 16, codePercentWidth:uint = 50, codePercentHeight:uint = 50):void
		{
