package net.alumican.as3.ui
{
	...
	public class RollOverButton extends Sprite
	{
		//----------------------------------------
		//CLASS CONSTANTS
		...
		*/
		 ...
		 * @param	useTween
		 */
		public function select(useTween:Boolean = true):void
		{
		 ...
		 * @param	useTween
		 */
		public function unselect(useTween:Boolean = true):void
		{
			if (!_isSelected) return;
			_isSelected = false;
			unselectEffect();
		 ...
		 * @param	useTween
		 */
		protected function _selectEffect(useTween:Boolean = true):void
		{
		}
		 ...
		 * @param	useTween
		 */
		protected function _unselectEffect(useTween:Boolean = true):void
		{
		}
		 ...
		 * @param	useTween
		 */
		protected function _rollOverEffect(useTween:Boolean = true):void
		{
		}
		 ...
		 * @param	useTween
		 */
		protected function _rollOutEffect(useTween:Boolean = true):void
		{
		}
