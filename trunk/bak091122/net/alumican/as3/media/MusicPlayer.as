package net.alumican.as3.media
{
	...
	public class MusicPlayer extends EventDispatcher
	{
		 ...
		 * @param	transition
		 */
		public function turnOn(volume:Number = 1.0, time:Number = 0.5, transition:IEasing = null):void
		{
		 ...
		 * @param	transition
		 */
		public function turnOff(volume:Number = 0.0, time:Number = 0.5, transition:IEasing = null):void
		{
			if (!_isTurning) return;
			_isTurning = false;
		 ...
		 * @param	transition
		 */
		private function _fadeVolume(volume:Number = 0.0, time:Number = 1.0, transition:IEasing = null, onComplete:Function = null):void
		{
			if (_fadeVolumeTween)
			{
